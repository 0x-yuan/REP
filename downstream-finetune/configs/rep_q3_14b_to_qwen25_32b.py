"""rep_q3_14b_to_qwen25_32b - Qwen3-14B REP traces -> Qwen2.5-32B-Instruct student
...
Student:  Qwen/Qwen2.5-32B-Instruct (FSDP, 8xB200)
Source:   the 10k pure-Qwen3-14B REP set (see SOURCE_REPO).
Supplementary row: 32B student, 100% Qwen3-14B REP traces. MATH500 0.875 at epoch 4 (n=3, T=0.5).

Run:  DISTILL_CONFIG=configs/rep_q3_14b_to_qwen25_32b.py  (loaded by ../engine/*.py scripts)
"""
...
# --- Run identity ------------------------------------------------------------
RUN_ID = "rep-q3pure-qwen25-32b-v1"
MODEL_FAMILY = "qwen25"
...
DATASET_SUBDIR = "rep_q3pure_qwen25_32b_text"

# --- Modal volumes + apps ----------------------------------------------------
CKPTS_VOL = "rep-q3pure-32b-ckpts"
RESULTS_VOL = "rep-q3pure-32b-results"
HF_CACHE_VOL = "rep-q3pure-32b-hfcache"
TRAIN_APP = "rep-q3pure-32b-train"
EVAL_APP = "rep-q3pure-32b-eval-multi"
...
HF_REPO = ""
HF_VARIANT_NOTE = "Student = Qwen2.5-32B-Instruct. 10k Qwen3-14B REP traces (distill_q3_14b_clean), clean {problem, solution}; solution is the plain SFT target (reasoning + boxed answer). FSDP full_shard."
