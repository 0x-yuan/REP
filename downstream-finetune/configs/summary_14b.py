"""summary_14b - Qwen2.5-7B summary of the trace + answer
...
Epochs:   6  (save_strategy=epoch; Reported cell = best epoch of 6 by Delta-sum. Control: reasoning trace replaced by a short summary.)
Teacher:  Qwen3-14B (ideal), trace summarized
Source:   engine template + a dataset built by ../data_builders/ (see SOURCE_REPO).

Run:  DISTILL_CONFIG=configs/summary_14b.py  (loaded by ../engine/*.py scripts)
"""
...
# --- Run identity ------------------------------------------------------------
RUN_ID = "summary-q3_14b-v1"
MODEL_FAMILY = "qwen25"
MODEL_NAME = "Qwen/Qwen2.5-7B-Instruct"

# --- Teacher dataset (the per-row knob) --------------------------------------
SOURCE_REPO = "your-org/summary_14b"  # build with ../data_builders/, push, then point here
DATASET_SUBDIR = "sum_q3_14b_qwen25_7b"

# --- Modal volumes + apps ----------------------------------------------------
CKPTS_VOL = "summary-q3_14b-ckpts"
RESULTS_VOL = "summary-q3_14b-results"
HF_CACHE_VOL = "summary-q3_14b-hfcache"
TRAIN_APP = "summary-q3_14b-train"
EVAL_APP = "summary-q3_14b-eval-multi"
...
HF_REPO = ""
HF_VARIANT_NOTE = "qwen3_14b teacher / variant=summary_answer"
