"""rep_14b_clean - full <think> trace (r1) + answer
...
Epochs:   5  (save_strategy=epoch; Reported cell = best epoch of 5 by Delta-sum over MATH500/AIME24/AIME25/JEE-Math/LCB.)
Teacher:  Qwen3-14B (clean, wrapper-stripped harvest)
Source:   training recipe + the published 14B clean teacher dataset (see SOURCE_REPO).

Run:  DISTILL_CONFIG=configs/rep_14b_clean.py  (loaded by ../engine/*.py scripts)
"""
...
# --- Run identity ------------------------------------------------------------
RUN_ID = "rep-distill-14bclean-v1"
MODEL_FAMILY = "qwen25"
MODEL_NAME = "Qwen/Qwen2.5-7B-Instruct"

# --- Teacher dataset (the per-row knob) --------------------------------------
SOURCE_REPO = "Chia-Mu-Lab/REP-datasets"
SOURCE_CONFIG = "distill_q3_14b_clean"
DATASET_SUBDIR = "clean10k_qwen14b_qwen25_7b_text"

# --- Modal volumes + apps ----------------------------------------------------
CKPTS_VOL = "rep-distill-qwen-ckpts"
RESULTS_VOL = "rep-distill-qwen-results"
HF_CACHE_VOL = "rep-distill-qwen-hfcache"
TRAIN_APP = "rep-distill-qwen-train"
EVAL_APP = "rep-distill-qwen-eval-multi"
