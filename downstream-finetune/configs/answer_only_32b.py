"""answer_only_32b - answer only (no reasoning trace)
...
Epochs:   6  (save_strategy=epoch; Reported cell = best epoch of 6 by Delta-sum. Control: answer only.)
Teacher:  Qwen3-32B (ideal)
Source:   engine template + a dataset built by ../data_builders/ (see SOURCE_REPO).

Run:  DISTILL_CONFIG=configs/answer_only_32b.py  (loaded by ../engine/*.py scripts)
"""
...
# --- Run identity ------------------------------------------------------------
RUN_ID = "answer-only-q3_32b-v1"
MODEL_FAMILY = "qwen25"
MODEL_NAME = "Qwen/Qwen2.5-7B-Instruct"

# --- Teacher dataset (the per-row knob) --------------------------------------
SOURCE_REPO = "your-org/answer_only_32b"  # build with ../data_builders/, push, then point here
DATASET_SUBDIR = "ans_q3_32b_qwen25_7b"

# --- Modal volumes + apps ----------------------------------------------------
CKPTS_VOL = "answer-only-q3_32b-ckpts"
RESULTS_VOL = "answer-only-q3_32b-results"
HF_CACHE_VOL = "answer-only-q3_32b-hfcache"
TRAIN_APP = "answer-only-q3_32b-train"
EVAL_APP = "answer-only-q3_32b-eval-multi"
...
HF_REPO = ""
HF_VARIANT_NOTE = "qwen3_32b teacher / variant=answer_only"
