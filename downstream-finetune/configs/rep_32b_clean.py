"""rep_32b_clean - full <think> trace (r1) + answer
...
Teacher:  Qwen3-32B (clean, wrapper-stripped harvest)
Source:   training recipe + the published 32B clean teacher dataset (see SOURCE_REPO).

Run:  DISTILL_CONFIG=configs/rep_32b_clean.py  (loaded by ../engine/*.py scripts)
"""
...
# --- Run identity ------------------------------------------------------------
RUN_ID = "rep-distill-32bclean-v1"
MODEL_FAMILY = "qwen25"
MODEL_NAME = "Qwen/Qwen2.5-7B-Instruct"

# --- Teacher dataset (the per-row knob) --------------------------------------
SOURCE_REPO = "Chia-Mu-Lab/REP-datasets"
SOURCE_CONFIG = "distill_q3_32b_clean"
DATASET_SUBDIR = "clean10k_qwen32b_qwen25_7b_text"

# --- Modal volumes + apps ----------------------------------------------------
CKPTS_VOL = "rep-distill-32bclean-ckpts"
RESULTS_VOL = "rep-distill-32bclean-results"
HF_CACHE_VOL = "rep-distill-32bclean-hfcache"
TRAIN_APP = "rep-distill-32bclean-train"
EVAL_APP = "rep-distill-32bclean-eval-multi"
