"""rep_32b_orig - full <think> trace (r1) + answer
...
Teacher:  Qwen3-32B (original harvest; wrapper stripped at prep time)
Source:   training recipe + the published 32B original teacher dataset (see SOURCE_REPO).

Run:  DISTILL_CONFIG=configs/rep_32b_orig.py  (loaded by ../engine/*.py scripts)
"""
...
# --- Run identity ------------------------------------------------------------
RUN_ID = "rep-distill-32borig-v1"
MODEL_FAMILY = "qwen25"
MODEL_NAME = "Qwen/Qwen2.5-7B-Instruct"

# --- Teacher dataset (the per-row knob) --------------------------------------
SOURCE_REPO = "Chia-Mu-Lab/REP-datasets"
SOURCE_CONFIG = "distill_q3_32b_original"
DATASET_SUBDIR = "orig10k_qwen32b_qwen25_7b_text"

# --- Modal volumes + apps ----------------------------------------------------
CKPTS_VOL = "rep-distill-32borig-ckpts"
RESULTS_VOL = "rep-distill-32borig-results"
HF_CACHE_VOL = "rep-distill-32borig-hfcache"
TRAIN_APP = "rep-distill-32borig-train"
EVAL_APP = "rep-distill-32borig-eval-multi"
